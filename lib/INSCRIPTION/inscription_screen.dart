...
class _InscriptionPageState extends State<InscriptionPage> {
  ...
  String? _dateNaissanceErrorMessage;
  ...
  void dispose() {
    ...
    _genderController.removeListener(_updateButtonState);
    _dateNaissanceController.removeListener(_updateButtonState);
  ...
  String? _validateDateNaissance(String? value) {
  ...
  void initState() {
    ...
    _genderController.addListener(_updateButtonState);
    _dateNaissanceController.addListener(_updateButtonState);
  ...
  bool _isFormValid() {
    return _pseudoController.text.isNotEmpty &&
        ...
        _validateDateNaissance(_dateNaissanceController.text) == null;
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    onTap: () {
                      ...
                      CustomGenderRoller.show(
                        context,
                        initialGender: _genderController.text.isNotEmpty ? _genderController.text : 'Homme',
                  ...
                  TextFormField(
                    ...
                    validator: _validateDateNaissance,
                    decoration: InputDecoration(
                  ...
                  if (_dateNaissanceErrorMessage != null)
                    Padding(
                      padding: const EdgeInsets.only(top: 8, left: 16),
                      child: Text(
                        _dateNaissanceErrorMessage!,
                        style: TextStyle(
                          color: Colors.red[400],
                          fontSize: 14,
                        ),
