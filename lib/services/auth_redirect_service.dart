...
class AuthRedirectService {
  ...
  /// 
  /// Retourne true si l'utilisateur est connecté, false s'il a été redirigé
  ...
  /// Exécute une fonction si l'utilisateur est connecté, sinon le redirige vers la page de connexion
  /// 
  /// Retourne le résultat de la fonction si l'utilisateur est connecté, null sinon
